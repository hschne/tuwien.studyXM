...
CREATE TABLE entity_question(questionid INTEGER AUTO_INCREMENT PRIMARY KEY, question VARCHAR(2000) NOT NULL, type INTEGER NOT NULL, question_time BIGINT NOT NULL, tag INTEGER NOT NULL);
