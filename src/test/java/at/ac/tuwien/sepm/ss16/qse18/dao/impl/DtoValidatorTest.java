 ...
 */
@RunWith(PowerMockRunner.class) @PrepareForTest(DtoValidator.class)
...
public class DtoValidatorTest {
    ...
    public void test_validate_withNoQuestionTextShouldThrowException() throws Exception {
        dtoValidator.validate(new Question(null, QuestionType.MULTIPLECHOICE, 1, Tag.EASY));
    }
    ...
    public void test_validate_withQuestionToLongShouldThrowException() throws Exception {
        ...
        dtoValidator.validate(new Question(questionText, QuestionType.MULTIPLECHOICE, 1, Tag.EASY));
    }
    ...
    public void test_validate_withEmptyQuestionStringShouldThrowException() throws Exception {
        dtoValidator.validate(new Question(" ", QuestionType.MULTIPLECHOICE, 1, Tag.EASY));
    }
    ...
    public void test_validate_withInvalidQuestionTimeShouldThrowException() throws Exception {
        ...
        dtoValidator.validate(new Question("question", QuestionType.MULTIPLECHOICE, -1, Tag.EASY));
    }
     ...
     * @throws Exception
     */
    @Test public void test_validate_withValidQuestion() throws Exception {
        dtoValidator.validate(new Question("question", QuestionType.MULTIPLECHOICE, 1, Tag.EASY));
    }
     ...
     * @throws Exception
     */
    @Test public void test_validateAuthor_withValidExam() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void test_validate_withCorrectAnswer() throws Exception {
     ...
     * @throws Exception
     */
    @Test public void test_validate_withValidResource() throws Exception {
